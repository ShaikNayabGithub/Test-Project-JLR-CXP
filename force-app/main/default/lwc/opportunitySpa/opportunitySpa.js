...
export default class OpportunitySpa extends NavigationMixin(LightningElement) {
    ...
    getSaleTypeDiv(saleType) {
        ...
        let cls = '.jlr-sale-type-' + saleType;
    ...
    setSelectedSaleType(saleType, doUpdateOpportunity) {
        ...
        } else if (saleType === PICKLIST_VAL_SALE_TYPE_DEMONSTRATOR) {
            this.setSaleTypeDivAsSelected(SALE_TYPES_DEMO, doUpdateOpportunity);
        } else if (saleType === PICKLIST_VAL_SALE_TYPE_PRE_OWNED) {
